...
# Load the text into a variable (replace this with your actual text)
text = """
...
# Use regex to split the text into two chunks based on the two headers
chunks = re.split(r"(2\.2 Approaches to Research)", text, maxsplit=1)

# Combine the second header with its content
chunk1 = chunks[0].strip()
chunk2 = (chunks[1] + chunks[2]).strip()

# Print the two chunks to verify
print("--- Chunk 1 ---")
print(chunk1)
print("\n--- Chunk 2 ---")
print(chunk2)
